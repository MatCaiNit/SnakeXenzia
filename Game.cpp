...
void Game::update(){
    ...
    if(SDL_GetTicks()>Mark+Delay){
        ...
        if(Snake_block[lengthofSnake-1].first+posx>block_size*9){
            Snake_block[lengthofSnake-1].first=-block_size;
        }
        if(Snake_block[lengthofSnake-1].first+posx<0){
            Snake_block[lengthofSnake-1].first=block_size*10;
        }
        if(Snake_block[lengthofSnake-1].second+posy>block_size*9){
            Snake_block[lengthofSnake-1].second=-block_size;
        }
        if(Snake_block[lengthofSnake-1].second+posy<0){
            Snake_block[lengthofSnake-1].second=block_size*10;
        }
